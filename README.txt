...
eurobarometerSummary.Rnw and the corresponding pdf contain exploratory data analysis.

main.R will run a single random restart to fit the a model to the full data 

optFixed2_q3HOfull_refit.rds was the optimal model selected from all random restarts. 

bootstrap_driver.R takes the optimal model (optFixed2_q3HOfull_refit.rds) and then bootstraps confidence sets for the variational parameters.
